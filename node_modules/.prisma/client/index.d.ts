  ...
  */
  ...
  export interface TodoItemDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    /**
     * Find zero or more TodoItems that matches the filter.
     * @param {TodoItemFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const todoItem = await prisma.todoItem.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: TodoItemFindRawArgs
    ): PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a TodoItem.
     * @param {TodoItemAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const todoItem = await prisma.todoItem.aggregateRaw({
     *   pipeline: [
   ...
   * TodoItem findRaw
   */
  export type TodoItemFindRawArgs = {
    /**
  ...
  /**
   * TodoItem aggregateRaw
   */
  export type TodoItemAggregateRawArgs = {
    /**
